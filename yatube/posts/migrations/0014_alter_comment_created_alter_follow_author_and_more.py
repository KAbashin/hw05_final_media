# Generated by Django 4.0.2 on 2022-04-16 19:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('posts', '0013_alter_comment_created'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='comment',
            name='created',
            field=models.DateTimeField(auto_now_add=True, help_text='Введите текст комментария', verbose_name='Дата публикации комментария'),
        ),
        migrations.AlterField(
            model_name='follow',
            name='author',
